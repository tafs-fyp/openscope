...
const GAME_EVENTS_POINT_VALUES = {
    ...
    COLLISION: -50,
    DEPARTURE: 10,
    EXTREME_CROSSWIND_OPERATION: 0,
    EXTREME_TAILWIND_OPERATION: -25,
    GO_AROUND: 0,
    HIGH_CROSSWIND_OPERATION: 0,
    HIGH_TAILWIND_OPERATION: -15,
    ILLEGAL_APPROACH_CLEARANCE: 0,
    LOCALIZER_INTERCEPT_ABOVE_GLIDESLOPE: 0,
    NOT_CLEARED_ON_ROUTE: 0,
    SEPARATION_LOSS: -25,
    NO_TAKEOFF_SEPARATION: -25
};
