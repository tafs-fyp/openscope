...
//         const waypoints = this.getAirCraftModel(targetCallsign).fms.waypoints;
        
//         if(getCurrentAltitude(callsign) === model.model.ceiling)  alValid = false;
//         if(getCurrentSpeed(callsign) === model.model.speed.max)   spValid = false;
...
//         if(getCurrentSpeed(callsign) < (model.model.speed.min+SPEEDINCREMENT))   spValid = false;
...
//             this.holdingAirCrafts[key].time -=1;
...
//                     continue;
//                 }
//                 if(this.resolutionsMade[id].vertical >  8 || this.resolutionsMade[id].horizontal > 8){
